...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('blog', '0006_remove_blogpostmodel_author_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('caption', models.CharField(help_text='you write a title', max_length=70, verbose_name='caption')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caption', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='blogpost', to='blog.captionmodel', verbose_name='caption')),
